...
-include tests/polaris_probe.mk
-include tests/polaris_integration.mk
-include tests/polaris_firmware.mk
-include tests/polaris_sdma.mk
-include tests/polaris_smu_toc.mk
-include tests/polaris_smu_mailbox.mk
-include tests/polaris_smu_stage.mk
...
test-driver-host: test-polaris-probe-host test-polaris-firmware-host test-polaris-sdma-host
test-driver-host: test-polaris-integration-host
test-driver-host: test-polaris-smu-toc-host test-polaris-smu-mailbox-host test-polaris-smu-stage-host
