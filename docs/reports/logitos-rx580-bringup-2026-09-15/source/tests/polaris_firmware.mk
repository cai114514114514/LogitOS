...
POLARIS_FW_SRC := tests/unit/polaris_firmware_test.c c/drivers/gpu/polaris_firmware.c
...
$(BUILD)/check-polaris-firmware: tools/check-polaris-firmware.c c/drivers/gpu/polaris_firmware.c c/drivers/gpu/polaris_firmware.h
	@mkdir -p $(BUILD)
	@$(CC) -std=c11 -O1 -g -Wall -Wextra -Werror -Ic/drivers/gpu \
	    tools/check-polaris-firmware.c c/drivers/gpu/polaris_firmware.c -o $@
