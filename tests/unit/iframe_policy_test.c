...
int main(int argc,char **argv)
{
    ...
    if(argc>1)goto done;
    ck(iframe_policy_blob_worker(NULL),1,"Blob Worker without policy");
    ck(iframe_policy_network_worker("https://child.example/page","https://child.example/worker.js",0),1,"network Worker same origin");
    ck(iframe_policy_network_worker("https://child.example/page","https://other.example/worker.js","worker-src *"),0,"classic Worker cross origin remains forbidden");
    ck(iframe_policy_network_worker("https://child.example/page","https://child.example/worker.js","worker-src 'self';script-src 'none'"),1,"worker-src overrides script policy");
    ck(iframe_policy_network_worker("https://child.example/page","https://child.example/worker.js","child-src 'self';script-src 'none'"),1,"network worker child fallback");
    ck(iframe_policy_network_worker("https://child.example/page","https://child.example/worker.js","default-src 'none'"),0,"network worker default refusal");
    ck(iframe_policy_network_worker("https://child.example/page","https://child.example/worker.js","worker-src 'self'\nworker-src 'none'"),0,"network worker policy intersection");
    ck(iframe_policy_network_worker("https://child.example/page","http://child.example/worker.js","worker-src *"),0,"network worker mixed content refused");
    ck(iframe_policy_blob_worker("worker-src blob:;default-src 'none'"),1,"worker-src takes precedence");
    ck(iframe_policy_blob_worker("worker-src 'none';child-src blob:"),0,"worker-src refusal wins");
    ck(iframe_policy_blob_worker("child-src blob:;script-src 'none'"),1,"worker child-src fallback");
    ck(iframe_policy_blob_worker("script-src blob:"),1,"worker script-src fallback");
    ck(iframe_policy_blob_worker("default-src blob:"),1,"worker default-src fallback");
    ck(iframe_policy_blob_worker("worker-src *"),0,"network wildcard does not grant Blob");
    ck(iframe_policy_blob_worker("worker-src blob:\nworker-src 'none'"),0,"worker policies intersect");
    ck(iframe_policy_worker_import("https://child.example/p","https://child.example/i.js","script-src 'self';script-src-elem 'none'"),1,"Worker import uses script-src not elem");
    ck(iframe_policy_worker_import("https://child.example/p","https://other.example/i.js","script-src 'none';script-src-elem *"),0,"Worker import cannot borrow elem grant");
    ck(iframe_policy_worker_import("https://child.example/p","https://other.example/i.js","script-src 'strict-dynamic'"),1,"non parser Worker import strict dynamic");
    ck(iframe_policy_worker_import("https://child.example/p","http://other.example/i.js","script-src 'strict-dynamic'"),0,"Worker mixed content refused");
    ck(iframe_policy_inline_script(0,0),1,"script without policy");
    ck(iframe_policy_inline_script("script-src 'none'",0),0,"inline script none");
    ck(iframe_policy_inline_script("script-src 'unsafe-inline'",0),1,"explicit inline script");
    ck(iframe_policy_inline_script("script-src 'nonce-YWJj' 'unsafe-inline'",0),0,"script nonce suppresses unsafe inline");
    ck(iframe_policy_inline_script("script-src 'nonce-YWJj'","YWJj"),1,"inline script exact nonce");
    ck(iframe_policy_inline_script("script-src 'nonce-YWJj'","ywjj"),0,"script nonce case sensitive");
    ck(iframe_policy_inline_script("script-src 'unsafe-inline' 'strict-dynamic'",0),0,"strict dynamic suppresses unsafe inline");
    ck(iframe_policy_script_attribute("script-src 'nonce-YWJj'"),0,"handler attributes cannot use nonce");
    ck(iframe_policy_script_attribute("script-src-attr 'none';script-src 'unsafe-inline'"),0,"handler attribute own directive");
    ck(iframe_policy_script_attribute("script-src-attr 'unsafe-inline';script-src 'none'"),1,"handler attr overrides generic");
    ck(iframe_policy_eval("script-src 'none';script-src-elem 'unsafe-eval'"),0,"eval ignores element directive");
    ck(iframe_policy_eval("default-src 'none';script-src 'unsafe-eval'"),1,"eval explicit grant");
    ck(iframe_policy_eval("default-src 'none'"),0,"eval fallback restriction");
    ck(iframe_policy_eval("script-src 'unsafe-eval'\nscript-src 'none'"),0,"eval policy intersection");
    ck(iframe_policy_resource("https://child.example/","https://child.example/data","connect-src 'self'",IF_POLICY_CONNECT),1,"connect self");
    ck(iframe_policy_resource("https://child.example/","https://other.example/data","connect-src 'self'",IF_POLICY_CONNECT),0,"connect cross origin denied");
    ck(iframe_policy_resource("https://child.example/","https://child.example/data","default-src 'none'",IF_POLICY_CONNECT),0,"connect default fallback");
    ck(iframe_policy_resource("https://child.example/","http://child.example/data","connect-src *",IF_POLICY_CONNECT),0,"connect mixed content denied");
    ck(iframe_policy_script("https://child.example/","https://child.example/a.js","script-src 'self'",0,1),1,"external script self");
    ck(iframe_policy_script("https://child.example/","https://other.example/a.js","script-src 'self'",0,1),0,"external script host denial");
    ck(iframe_policy_script("https://child.example/","https://other.example/a.js","script-src 'nonce-YWJj'","YWJj",1),1,"external script nonce grant");
    ck(iframe_policy_script("https://child.example/","https://other.example/a.js","script-src 'nonce-YWJj' 'strict-dynamic'",0,0),1,"strict dynamic native insertion provenance");
    ck(iframe_policy_script("https://child.example/","https://other.example/a.js","script-src https: 'strict-dynamic'",0,1),0,"strict dynamic ignores parser host allowlist");
    ck(iframe_policy_script("https://child.example/","https://other.example/a.js","script-src 'nonce-YWJj'\nscript-src 'none'","YWJj",1),0,"script nonce does not override second policy");
