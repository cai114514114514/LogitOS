...
base=['cc','-O1','-g','-Wall','-Wextra','-Wno-unused-function','-Wno-type-limits','-fsanitize=address,undefined','-Itests/unit/fsstub','-Ic/fs','-Ic/drivers/block']
...
import tempfile
binary=out/'binding'
subprocess.run(base+['-Iinclude','-Iinclude/abi','-Ic/lib/gfx','tests/unit/project_binding_test.c','c/lib/agent/files.c','c/lib/agent/task.c','c/lib/agent/store.c','c/drivers/block/crc32.c','-o',str(binary)],cwd=ROOT,check=True)
