 ...
 *
 *   - c/kernel/gui/fb/fb.c COMPILES AND LINKS ON THE HOST unmodified.  Its only
 ...
 *     the raster     c/kernel/gui/fb/fb.c      (fill/round-rect/blit/clip/glyph)
 ...
 * c/kernel/gui/fb/fb.h and c/kernel/gui/text.h; a mismatch is a link error, not a
 * silent divergence. */
