...
/* The second half lives in libctest_more.h -- same translation unit, split only
 * so that neither file becomes unreadable. It covers everything added when this
 * library was made buildable-against by third-party C, and every value it
 * asserts was generated by glibc on the host. */
#include "libctest_more.h"
#include "libctest_expand.h"
