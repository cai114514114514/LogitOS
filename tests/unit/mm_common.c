 ...
 * c/kernel/mm/reclaim/swap.c's slot arithmetic (header sectors, 8 sectors per slot) is
...
/* The three entry points c/kernel/mm/reclaim/swap.c declares under MM_HOSTTEST. */
