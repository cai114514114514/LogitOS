...
$(BUILD)/web_crypto_ops_test: $(WEB_CRYPTO_OPS_DEPS)
	$(CC) -O2 -w $(DOMIFACE_CF) -Ic/crypto $(KCPU_INC) -o $@ $(WEB_CRYPTO_OPS_SRC) $(HTML_PARSER_SRC) $(QJS_SRC) $(BUILD)/libcss_host.a $(RUST_LIB_HOST) -lm
$(BUILD)/web_crypto_ops_negctl: $(WEB_CRYPTO_OPS_DEPS)
	$(CC) -O2 -w $(DOMIFACE_CF) -Ic/crypto $(KCPU_INC) -DJS_CRYPTO_OPS_NEGCTL -DJS_CRYPTO_KDF_NEGCTL -DJS_CRYPTO_GCM_NEGCTL -o $@ $(WEB_CRYPTO_OPS_SRC) $(HTML_PARSER_SRC) $(QJS_SRC) $(BUILD)/libcss_host.a $(RUST_LIB_HOST) -lm
