...
FB_NATIVE_PRESENT_SRC := tests/unit/fb_native_present_test.c c/kernel/gui/fb/fb.c c/lib/gfx/adapters/openlogit_display.c
FB_NATIVE_PRESENT_INC := $(KGUI_INC) -Ic/drivers/virtio $(KMM_INC) -Ic/lib/text $(GFX_INC)
