# Site scoreboard collapse-recount-b

commit 9ba575e93, ISO build-collapse/logit.iso (sha256:e92960a838ea8006), 21 sites (+2 controls), 1 run(s) each, 332 s wall

BLANK 3, ERRORS 13, GAP 1, PAINTED 4
...
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| doubao             | BLANK      |    7.9 |     8 |      6/8 |   0 |       2920 |        6/45 | HTTP 200 |
| douyin             | BLANK      |    1.3 |    33 |     1/33 |   1 |       2408 |      31/213 | HTTP 200 |
| weixin             | BLANK      |    2.5 |     5 |      5/5 |   0 |       2568 |      23/149 | HTTP 200 |
| 2345               | ERRORS     |    6.1 |    32 |    18/32 |   2 |       6408 |      22/249 | HTTP 200 |
| anthropic          | ERRORS     |   10.3 |    14 |    13/14 |   2 |       7032 |       13/63 | HTTP 200 |
| apple              | ERRORS     |   23.6 |    49 |    25/49 |   2 |     616556 |       17/77 | HTTP 200 |
| baidu              | ERRORS     |    0.7 |    19 |     1/19 |   3 |      30816 |      33/389 | HTTP 200 |
| bing               | ERRORS     |    3.1 |     6 |      6/6 |   1 |     597340 |       10/54 | HTTP 200 |
| github             | ERRORS     |   96.2 |    94 |    28/94 |   1 |     221444 |      71/271 | HTTP 200 |
| google-search      | ERRORS     |    4.3 |     3 |      1/3 |   1 |      17148 |      41/273 | HTTP 200 |
| jd                 | ERRORS     |    7.9 |    17 |  18/17 ! |   7 |       8664 |        2/12 | HTTP 200 |
| kimi               | ERRORS     |   35.1 |   112 |   32/112 |   1 |      12240 |      21/157 | HTTP 200 |
| openai             | ERRORS     |    2.5 |     2 |        - |   1 |      25836 |     111/574 | HTTP 403 |
| python             | ERRORS     |    5.5 |    14 |  15/14 ! |   1 |     612884 |      42/124 | HTTP 200 |
| qwen               | ERRORS     |   59.9 |    23 |     6/23 |   2 |     614960 |      26/104 | HTTP 200 |
| stripe             | ERRORS     |   46.6 |    80 |    79/80 |   1 |      21960 |      41/125 | HTTP 200 |
| bing-search        | GAP        |    6.1 |    95 |  97/95 ! |   0 |      15496 |        9/60 | HTTP 200 |
| bilibili           | PAINTED    |   17.6 |    22 |     8/22 |   0 |     224188 |      57/524 | HTTP 200 |
| deepseek           | PAINTED    |    4.9 |    22 |    22/22 |   0 |     615836 |      70/361 | HTTP 200 |
| google             | PAINTED    |    3.1 |     4 |      2/4 |   0 |      17752 |       18/92 | HTTP 200 |
| qq                 | PAINTED    |   15.2 |    16 |     8/16 |   0 |     244052 |     71/1141 | HTTP 200 |

CONTROLS -- harness health, not results:
| control            | verdict    | load s |  reqs | asked/got | exc | changed px |  text run/B | host     |
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| control-example    | PAINTED    |    1.3 |     1 |      1/1 |   0 |       8800 |      19/109 | HTTP 200 |
| control-wikipedia  | PAINTED    |   14.0 |    36 |     4/36 |   0 |      82556 |    207/1176 | HTTP 200 |
...
verdict:  loaded in 7.9s and painted 2920 changed pixels (0 exceptions)
host:     HTTP 200, 482154 bytes, 0.9s, 15 <script> (4 src), 1 <img>, redirects: 302 -> https://www.doubao.com/chat/
document: 1 stylesheets, 4 script src, 9 inline script, 1 img, 3 preload, 0 font -> 6 mandatory subresources
pixels:   changed 2920 (blank control ink 4256), ink 4256, colours 363, rich-tile proxy 8, bbox [152, 12, 1264, 764]
network:  8 requests, 4 connections dialled, 5 reused, 0 modules (0 failed)
non-executable <script> blocks skipped: 2
shot:     tests/scoreboard/collapse-recount-b/doubao.png

### douyin -- BLANK
url:      https://www.douyin.com/
reported: nothing renders at all
verdict:  loaded in 1.3s and painted 2408 changed pixels (1 exceptions)
...
pixels:   changed 2408 (blank control ink 4256), ink 4349, colours 370, rich-tile proxy 9, bbox [140, 16, 1256, 764]
...
shot:     tests/scoreboard/collapse-recount-b/douyin.png

### weixin -- BLANK
url:      https://weixin.qq.com/
reported: same as douyin -- nothing renders
verdict:  loaded in 2.5s and painted 2568 changed pixels (0 exceptions)
...
pixels:   changed 2568 (blank control ink 4256), ink 4256, colours 370, rich-tile proxy 8, bbox [152, 12, 1264, 764]
network:  5 requests, 3 connections dialled, 2 reused, 0 modules (0 failed)
non-executable <script> blocks skipped: 1
shot:     tests/scoreboard/collapse-recount-b/weixin.png

### 2345 -- ERRORS
url:      https://www.2345.com/
reported: TypeError toString of undefined
verdict:  painted 6408 changed px in 6.1s but 2 JS exception(s)
host:     HTTP 200, 171920 bytes, 0.1s, 19 <script> (12 src), 13 <img>
document: 6 stylesheets, 11 script src, 8 inline script, 13 img, 83 preload, 0 font -> 18 mandatory subresources
pixels:   changed 6408 (blank control ink 4256), ink 5401, colours 523, rich-tile proxy 13, bbox [152, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/2345.png

### anthropic -- ERRORS
url:      https://www.anthropic.com/
reported: "is not a function"
verdict:  painted 7032 changed px in 10.3s but 2 JS exception(s)
host:     HTTP 200, 190425 bytes, 0.9s, 20 <script> (11 src), 0 <img>
document: 1 stylesheets, 11 script src, 9 inline script, 0 img, 0 preload, 0 font -> 13 mandatory subresources
pixels:   changed 7032 (blank control ink 4256), ink 6065, colours 539, rich-tile proxy 9, bbox [148, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/anthropic.png

### apple -- ERRORS
url:      https://www.apple.com/
reported: 0 images; TypeError split of undefined
verdict:  painted 616556 changed px in 23.6s but 2 JS exception(s)
...
pixels:   changed 616556 (blank control ink 4256), ink 49020, colours 809, rich-tile proxy 9, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/apple.png

### baidu -- ERRORS
url:      https://www.baidu.com/
reported: opens but unusable; a redirect works host-side and not on the machine
verdict:  painted 30816 changed px in 0.7s but 3 JS exception(s)
...
pixels:   changed 30816 (blank control ink 4256), ink 7404, colours 708, rich-tile proxy 12, bbox [152, 12, 1264, 768]
...
shot:     tests/scoreboard/collapse-recount-b/baidu.png
...
verdict:  painted 597340 changed px in 3.1s but 1 JS exception(s)
host:     HTTP 200, 185505 bytes, 0.5s, 22 <script> (4 src), 3 <img>, redirects: 302 -> https://cn.bing.com/
document: 1 stylesheets, 4 script src, 9 inline script, 1 img, 2 preload, 0 font -> 6 mandatory subresources
pixels:   changed 597340 (blank control ink 4256), ink 488585, colours 499, rich-tile proxy 13, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/bing.png

### github -- ERRORS
url:      https://github.com/
reported: "很奇怪"
verdict:  painted 221444 changed px in 96.2s but 1 JS exception(s)
host:     HTTP 200, 573816 bytes, 0.7s, 15 <script> (9 src), 24 <img>
document: 18 stylesheets, 9 script src, 0 inline script, 22 img, 77 preload, 1 font -> 28 mandatory subresources
pixels:   changed 221444 (blank control ink 4256), ink 83024, colours 2022, rich-tile proxy 25, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/github.png

### google-search -- ERRORS
url:      https://www.google.com/search?q=python
reported: "只要搜索入一个 Paton" -- the homepage renders; this is the path the owner actually uses
verdict:  painted 17148 changed px in 4.3s but 1 JS exception(s)
host:     HTTP 200, 91585 bytes, 0.9s, 5 <script> (0 src), 0 <img>
document: 0 stylesheets, 0 script src, 5 inline script, 0 img, 0 preload, 0 font -> 1 mandatory subresources
pixels:   changed 17148 (blank control ink 4256), ink 11921, colours 643, rich-tile proxy 17, bbox [152, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/google-search.png

### jd -- ERRORS
url:      https://www.jd.com/
reported: jQuery is not defined
verdict:  painted 8664 changed px in 7.9s but 7 JS exception(s) -- and the document asked for 18 subresources (3 stylesheets, 14 script srcs) against 17 requests issued, short by 1
host:     HTTP 200, 191658 bytes, 0.1s, 35 <script> (14 src), 12 <img>
...
pixels:   changed 8664 (blank control ink 4256), ink 4256, colours 410, rich-tile proxy 9, bbox [140, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/jd.png
...
verdict:  painted 12240 changed px in 35.1s but 1 JS exception(s)
...
shot:     tests/scoreboard/collapse-recount-b/kimi.png

### openai -- ERRORS
url:      https://openai.com/
reported: an icon and nothing else
verdict:  painted 25836 changed px in 2.5s but 1 JS exception(s)
host:     HTTP 403, 0 bytes, 0.4s, 0 <script> (0 src), 0 <img>
pixels:   changed 25836 (blank control ink 4256), ink 5094, colours 675, rich-tile proxy 11, bbox [152, 16, 1256, 764]
...
shot:     tests/scoreboard/collapse-recount-b/openai.png

### python -- ERRORS
url:      https://www.python.org/
reported: (new 2026-08-28: user reports it does not open)
verdict:  painted 612884 changed px in 5.5s but 1 JS exception(s) -- and the document asked for 15 subresources (4 stylesheets, 10 script srcs) against 14 requests issued, short by 1
host:     HTTP 200, 52537 bytes, 0.6s, 13 <script> (10 src), 1 <img>
...
pixels:   changed 612884 (blank control ink 4256), ink 501824, colours 971, rich-tile proxy 20, bbox [140, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/python.png

### qwen -- ERRORS
url:      https://chat.qwen.ai/
reported: hangs
verdict:  painted 614960 changed px in 59.9s but 2 JS exception(s)
host:     HTTP 200, 196957 bytes, 0.3s, 18 <script> (3 src), 6 <img>
document: 2 stylesheets, 3 script src, 15 inline script, 6 img, 7 preload, 0 font -> 6 mandatory subresources
pixels:   changed 614960 (blank control ink 4256), ink 510839, colours 596, rich-tile proxy 9, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/qwen.png

### stripe -- ERRORS
url:      https://stripe.com/
reported: 73 scripts, extremely slow
verdict:  painted 21960 changed px in 46.6s but 1 JS exception(s)
host:     HTTP 200, 653733 bytes, 1.5s, 77 <script> (74 src), 35 <img>
document: 5 stylesheets, 73 script src, 0 inline script, 35 img, 13 preload, 2 font -> 79 mandatory subresources
pixels:   changed 21960 (blank control ink 4256), ink 12988, colours 693, rich-tile proxy 9, bbox [152, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount-b/stripe.png

### bing-search -- GAP
url:      https://www.bing.com/search?q=python
reported: "我使用bing搜索python成功返回了结果!!!可是......CSS渲染根本无法正常使用"
verdict:  painted 15496 changed px in 6.1s and threw nothing, but never requested 2 of the 97 subresources the document asks for (90 stylesheets in the document)
host:     HTTP 200, 97845 bytes, 0.5s, 20 <script> (6 src), 3 <img>, redirects: 302 -> https://cn.bing.com/search?q=python
document: 90 stylesheets, 6 script src, 14 inline script, 1 img, 4 preload, 0 font -> 97 mandatory subresources
GAP:      the guest issued 95 requests against 97 mandatory -- SHORT BY 2. A request never made cannot appear in fetch_failed; this is the only column that sees it.
pixels:   changed 15496 (blank control ink 4256), ink 4776, colours 494, rich-tile proxy 11, bbox [140, 12, 1264, 764]
network:  95 requests, 5 connections dialled, 91 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/bing-search.png

### bilibili -- PAINTED
url:      https://www.bilibili.com/
reported: TypeError split of undefined
verdict:  painted 224188 changed px in 17.6s, no JS exceptions, no subresource gap
host:     HTTP 200, 116636 bytes, 0.3s, 21 <script> (8 src), 13 <img>
document: 1 stylesheets, 6 script src, 12 inline script, 12 img, 1 preload, 0 font -> 8 mandatory subresources
pixels:   changed 224188 (blank control ink 4256), ink 164548, colours 17287, rich-tile proxy 785, bbox [140, 12, 1264, 764]
network:  22 requests, 9 connections dialled, 13 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/bilibili.png

### control-example -- PAINTED
url:      http://example.com/
reported: CONTROL: the simplest page on the web, no JS, no CSS worth the name
verdict:  painted 8800 changed px in 1.3s, no JS exceptions, no subresource gap
...
pixels:   changed 8800 (blank control ink 4256), ink 9184, colours 545, rich-tile proxy 9, bbox [140, 12, 1260, 764]
network:  1 requests, 1 connections dialled, 0 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/control-example.png

### control-wikipedia -- PAINTED
url:      https://en.wikipedia.org/wiki/Operating_system
reported: CONTROL: known to render since M13
verdict:  painted 82556 changed px in 14.0s, no JS exceptions, no subresource gap
host:     HTTP 200, 676091 bytes, 1.3s, 5 <script> (1 src), 26 <img>
document: 2 stylesheets, 1 script src, 3 inline script, 24 img, 2 preload, 0 font -> 4 mandatory subresources
pixels:   changed 82556 (blank control ink 4256), ink 20391, colours 1362, rich-tile proxy 52, bbox [152, 12, 1264, 764]
...
non-executable <script> blocks skipped: 1
shot:     tests/scoreboard/collapse-recount-b/control-wikipedia.png

### deepseek -- PAINTED
url:      https://www.deepseek.com/
reported: blank; needs Worker
verdict:  painted 615836 changed px in 4.9s, no JS exceptions, no subresource gap
...
pixels:   changed 615836 (blank control ink 4256), ink 18178, colours 1331, rich-tile proxy 39, bbox [140, 12, 1264, 768]
network:  22 requests, 2 connections dialled, 20 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/deepseek.png

### google -- PAINTED
url:      https://www.google.com/
reported: "验证都无法加载出来" -- the bot check appears and its challenge will not render
verdict:  painted 17752 changed px in 3.1s, no JS exceptions, no subresource gap
host:     HTTP 200, 87077 bytes, 1.0s, 10 <script> (0 src), 1 <img>
document: 1 stylesheets, 0 script src, 10 inline script, 1 img, 0 preload, 0 font -> 2 mandatory subresources
pixels:   changed 17752 (blank control ink 4256), ink 5607, colours 735, rich-tile proxy 10, bbox [140, 12, 1264, 764]
network:  4 requests, 2 connections dialled, 2 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/google.png

### qq -- PAINTED
url:      https://www.qq.com/
reported: Uncaught (in promise) undefined
verdict:  painted 244052 changed px in 15.2s, no JS exceptions, no subresource gap
host:     HTTP 200, 126956 bytes, 0.2s, 13 <script> (7 src), 17 <img>
document: 1 stylesheets, 6 script src, 6 inline script, 16 img, 0 preload, 0 font -> 8 mandatory subresources
pixels:   changed 244052 (blank control ink 4256), ink 148190, colours 1057, rich-tile proxy 45, bbox [140, 12, 1264, 764]
network:  16 requests, 7 connections dialled, 9 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount-b/qq.png
