# Site scoreboard 2026-09-02

commit fe748e31e, ISO build-cache/logit.iso (sha256:b2cf3dd947fd73aa), 0 sites (+1 controls), 1 run(s) each, 43 s wall
...
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| control-example    | PAINTED    |    0.7 |     1 |      1/1 |   0 |       8792 |      19/109 | HTTP 200 |
...
verdict:  painted 8792 changed px in 0.7s, no JS exceptions, no subresource gap
...
pixels:   changed 8792 (blank control ink 4256), ink 9184, colours 545, rich-tile proxy 9, bbox [140, 12, 1264, 764]
network:  1 requests, 1 connections dialled, 0 reused, 0 modules (0 failed)
shot:     tests/scoreboard/2026-09-02/control-example.png
