# Site scoreboard speed-0913-before

commit 41d7a74e8, ISO build-browser-speed-0913/before/logit.iso (sha256:5e33a17a9acfce48), 6 sites (+1 controls), 1 run(s) each, 249 s wall
...
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| apple              | ERRORS     |    7.3 |    28 |    22/28 |   0 |     520616 |      33/150 | HTTP 200 |
| baidu              | ERRORS     |    0.7 |    15 |     1/15 |   3 |      80988 |      44/491 | HTTP 200 |
| bing-search        | ERRORS     |    3.1 |    96 |  99/96 ! |   0 |      10696 |      73/430 | HTTP 200 |
| stripe             | ERRORS     |   17.5 |    78 |    78/78 |   0 |       8876 |      11/330 | HTTP 200 |
| bilibili           | PAINTED    |    5.5 |     9 |      8/9 |   0 |     278176 |      52/472 | HTTP 200 |
| weixin             | PAINTED    |    1.9 |     5 |      5/5 |   0 |     618680 |      24/152 | HTTP 200 |

CONTROLS -- harness health, not results:
| control            | verdict    | load s |  reqs | asked/got | exc | changed px |  text run/B | host     |
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| control-example    | PAINTED    |    1.9 |     1 |      1/1 |   0 |       8696 |      19/109 | HTTP 200 |
...
verdict:  painted 520616 changed px, with 1 resource failure diagnostics
host:     HTTP 200, 312779 bytes, 1.3s, 17 <script> (12 src), 100 <img>
document: 9 stylesheets, 12 script src, 1 inline script, 43 img, 0 preload, 0 font -> 22 mandatory subresources
pixels:   changed 520616 (blank control ink 4256), ink 421343, colours 690, rich-tile proxy 12, bbox [140, 16, 1260, 764]
...
shot:     build-browser-speed-0913/evidence/live-before/apple.png

### baidu -- ERRORS
url:      https://www.baidu.com/
reported: opens but unusable; a redirect works host-side and not on the machine
verdict:  painted 80988 changed px in 0.7s but 3 JS exception(s)
...
pixels:   changed 80988 (blank control ink 4256), ink 8243, colours 783, rich-tile proxy 13, bbox [152, 12, 1260, 764]
...
shot:     build-browser-speed-0913/evidence/live-before/baidu.png

### bing-search -- ERRORS
url:      https://www.bing.com/search?q=python
reported: "我使用bing搜索python成功返回了结果!!!可是......CSS渲染根本无法正常使用"
verdict:  painted 10696 changed px, with 0 page-reported error(s) and 3 fetch error(s) -- and the document asked for 99 subresources (92 stylesheets, 6 script srcs) against 96 requests issued, short by 3
host:     HTTP 200, 97613 bytes, 0.6s, 20 <script> (6 src), 3 <img>, redirects: 302 -> https://cn.bing.com/search?q=python
document: 92 stylesheets, 6 script src, 14 inline script, 1 img, 4 preload, 0 font -> 99 mandatory subresources
GAP:      the guest issued 96 requests against 99 mandatory -- SHORT BY 3. A request never made cannot appear in fetch_failed; this is the only column that sees it.
pixels:   changed 10696 (blank control ink 4256), ink 4962, colours 516, rich-tile proxy 11, bbox [140, 12, 1264, 764]
network:  96 requests, 2 connections dialled, 94 reused, 0 modules (0 failed)
shot:     build-browser-speed-0913/evidence/live-before/bing-search.png

### stripe -- ERRORS
url:      https://stripe.com/
reported: 73 scripts, extremely slow
verdict:  painted 8876 changed px, with 16 page-reported error(s) and 0 fetch error(s)
host:     HTTP 200, 720872 bytes, 4.1s, 76 <script> (73 src), 29 <img>, redirects: 307 -> https://stripe.com/jp
document: 5 stylesheets, 72 script src, 0 inline script, 29 img, 13 preload, 2 font -> 78 mandatory subresources
pixels:   changed 8876 (blank control ink 4256), ink 6647, colours 675, rich-tile proxy 8, bbox [152, 12, 1264, 764]
network:  78 requests, 2 connections dialled, 77 reused, 0 modules (0 failed)
sub-resource failures (3):
    [img] fetch failed (status 0): https://q.stripe.com?cid=f67e004e-af4b-0ebe-f17e-35d1e338f040&lsid=f67e004e-af4b-0ebe-f17e-35d1e338f040&analytics_ua=analytics.js-CURRENT_VERSION&page=%2Fjp&referrer=&domain=stripe: cookie header exceeds capacity
    [img] fetch failed (status 0): https://q.stripe.com?cid=f67e004e-af4b-0ebe-f17e-35d1e338f040&lsid=f67e004e-af4b-0ebe-f17e-35d1e338f040&analytics_ua=analytics.js-CURRENT_VERSION&page=%2Fjp&referrer=&domain=stripe: cookie header exceeds capacity
    [img] fetch failed (status 0): https://q.stripe.com?cid=f67e004e-af4b-0ebe-f17e-35d1e338f040&lsid=f67e004e-af4b-0ebe-f17e-35d1e338f040&analytics_ua=analytics.js-CURRENT_VERSION&page=%2Fjp&referrer=&domain=stripe: cookie header exceeds capacity
non-executable <script> blocks skipped: 3
shot:     build-browser-speed-0913/evidence/live-before/stripe.png

### bilibili -- PAINTED
url:      https://www.bilibili.com/
reported: TypeError split of undefined
verdict:  painted 278176 changed px in 5.5s, no JS exceptions, no subresource gap
host:     HTTP 200, 118469 bytes, 0.3s, 21 <script> (8 src), 13 <img>
document: 1 stylesheets, 6 script src, 12 inline script, 12 img, 1 preload, 0 font -> 8 mandatory subresources
pixels:   changed 278176 (blank control ink 4256), ink 170648, colours 14667, rich-tile proxy 769, bbox [140, 20, 1260, 764]
network:  9 requests, 3 connections dialled, 6 reused, 0 modules (0 failed)
shot:     build-browser-speed-0913/evidence/live-before/bilibili.png

### control-example -- PAINTED
url:      http://example.com/
reported: CONTROL: the simplest page on the web, no JS, no CSS worth the name
verdict:  painted 8696 changed px in 1.9s, no JS exceptions, no subresource gap
host:     HTTP 200, 559 bytes, 1.6s, 0 <script> (0 src), 0 <img>
document: 0 stylesheets, 0 script src, 0 inline script, 0 img, 0 preload, 0 font -> 1 mandatory subresources
pixels:   changed 8696 (blank control ink 4256), ink 9184, colours 545, rich-tile proxy 8, bbox [152, 16, 1256, 764]
network:  1 requests, 1 connections dialled, 0 reused, 0 modules (0 failed)
shot:     build-browser-speed-0913/evidence/live-before/control-example.png

### weixin -- PAINTED
url:      https://weixin.qq.com/
reported: same as douyin -- nothing renders
verdict:  painted 618680 changed px in 1.9s, no JS exceptions, no subresource gap
host:     HTTP 200, 112625 bytes, 0.2s, 10 <script> (5 src), 0 <img>
document: 1 stylesheets, 3 script src, 3 inline script, 0 img, 5 preload, 0 font -> 5 mandatory subresources
pixels:   changed 618680 (blank control ink 4256), ink 4256, colours 576, rich-tile proxy 19, bbox [140, 12, 1264, 764]
network:  5 requests, 4 connections dialled, 1 reused, 0 modules (0 failed)
non-executable <script> blocks skipped: 1
shot:     build-browser-speed-0913/evidence/live-before/weixin.png
