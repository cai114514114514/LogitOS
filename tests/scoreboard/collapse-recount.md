# Site scoreboard collapse-recount

commit 9ba575e93, ISO build-collapse/logit.iso (sha256:e92960a838ea8006), 21 sites (+2 controls), 1 run(s) each, 330 s wall

BLANK 3, ERRORS 13, PAINTED 5
...
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| doubao             | BLANK      |    8.5 |     8 |      6/8 |   0 |       2972 |        6/45 | HTTP 200 |
| douyin             | BLANK      |    1.3 |    33 |     1/33 |   1 |       2684 |      31/213 | HTTP 200 |
| weixin             | BLANK      |    1.9 |     5 |      5/5 |   0 |       2500 |      23/149 | HTTP 200 |
| 2345               | ERRORS     |    6.7 |    32 |    18/32 |   2 |       6428 |      22/249 | HTTP 200 |
| anthropic          | ERRORS     |   12.2 |    14 |    13/14 |   2 |       7064 |       13/63 | HTTP 200 |
| apple              | ERRORS     |   21.2 |    49 |    25/49 |   2 |     616492 |       17/77 | HTTP 200 |
| baidu              | ERRORS     |    0.7 |    19 |     1/19 |   3 |      30816 |      33/389 | HTTP 200 |
| bing               | ERRORS     |    2.5 |     6 |      6/6 |   1 |     597724 |       10/54 | HTTP 200 |
| github             | ERRORS     |   95.0 |    94 |    28/94 |   1 |     221312 |      71/271 | HTTP 200 |
| google-search      | ERRORS     |    2.5 |     3 |      1/3 |   1 |      17432 |      41/273 | HTTP 200 |
| jd                 | ERRORS     |    7.9 |    17 |  18/17 ! |   7 |       8672 |        2/12 | HTTP 200 |
| kimi               | ERRORS     |   35.7 |   112 |   32/112 |   1 |      12288 |      21/157 | HTTP 200 |
| openai             | ERRORS     |    2.5 |     2 |        - |   1 |      25904 |     111/574 | HTTP 403 |
| python             | ERRORS     |    6.1 |    14 |  15/14 ! |   1 |     612836 |      42/124 | HTTP 200 |
| qwen               | ERRORS     |   60.5 |    23 |     6/23 |   2 |     614968 |      26/104 | HTTP 200 |
| stripe             | ERRORS     |   26.1 |    80 |    79/80 |   1 |      21956 |      41/125 | HTTP 200 |
| bilibili           | PAINTED    |   23.0 |    22 |     8/22 |   0 |     224164 |      57/534 | HTTP 200 |
| bing-search        | PAINTED    |    6.1 |    99 |    98/99 |   0 |      13032 |        9/60 | HTTP 200 |
| deepseek           | PAINTED    |    4.3 |    22 |    22/22 |   0 |     615860 |      70/361 | HTTP 200 |
| google             | PAINTED    |    3.1 |     4 |      2/4 |   0 |      17716 |       18/92 | HTTP 200 |
| qq                 | PAINTED    |   16.4 |    16 |     8/16 |   0 |     243864 |     71/1141 | HTTP 200 |

CONTROLS -- harness health, not results:
| control            | verdict    | load s |  reqs | asked/got | exc | changed px |  text run/B | host     |
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| control-example    | PAINTED    |    1.3 |     1 |      1/1 |   0 |       8772 |      19/109 | HTTP 200 |
| control-wikipedia  | PAINTED    |   15.8 |    35 |     4/35 |   0 |      82556 |    207/1176 | HTTP 200 |
...
verdict:  loaded in 8.5s and painted 2972 changed pixels (0 exceptions)
host:     HTTP 200, 479730 bytes, 0.9s, 15 <script> (4 src), 1 <img>, redirects: 302 -> https://www.doubao.com/chat/
document: 1 stylesheets, 4 script src, 9 inline script, 1 img, 3 preload, 0 font -> 6 mandatory subresources
pixels:   changed 2972 (blank control ink 4256), ink 4256, colours 363, rich-tile proxy 8, bbox [152, 12, 1264, 764]
network:  8 requests, 4 connections dialled, 5 reused, 0 modules (0 failed)
non-executable <script> blocks skipped: 2
shot:     tests/scoreboard/collapse-recount/doubao.png

### douyin -- BLANK
url:      https://www.douyin.com/
reported: nothing renders at all
verdict:  loaded in 1.3s and painted 2684 changed pixels (1 exceptions)
host:     HTTP 200, 72914 bytes, 0.3s, 2 <script> (0 src), 0 <img>
document: 0 stylesheets, 0 script src, 2 inline script, 0 img, 0 preload, 0 font -> 1 mandatory subresources
pixels:   changed 2684 (blank control ink 4256), ink 4539, colours 398, rich-tile proxy 9, bbox [148, 12, 1256, 764]
...
shot:     tests/scoreboard/collapse-recount/douyin.png

### weixin -- BLANK
url:      https://weixin.qq.com/
reported: same as douyin -- nothing renders
verdict:  loaded in 1.9s and painted 2500 changed pixels (0 exceptions)
...
pixels:   changed 2500 (blank control ink 4256), ink 4256, colours 370, rich-tile proxy 8, bbox [152, 12, 1256, 764]
network:  5 requests, 3 connections dialled, 2 reused, 0 modules (0 failed)
non-executable <script> blocks skipped: 1
shot:     tests/scoreboard/collapse-recount/weixin.png

### 2345 -- ERRORS
url:      https://www.2345.com/
reported: TypeError toString of undefined
verdict:  painted 6428 changed px in 6.7s but 2 JS exception(s)
host:     HTTP 200, 171920 bytes, 0.2s, 19 <script> (12 src), 13 <img>
document: 6 stylesheets, 11 script src, 8 inline script, 13 img, 83 preload, 0 font -> 18 mandatory subresources
pixels:   changed 6428 (blank control ink 4256), ink 5401, colours 523, rich-tile proxy 13, bbox [152, 12, 1260, 764]
...
shot:     tests/scoreboard/collapse-recount/2345.png

### anthropic -- ERRORS
url:      https://www.anthropic.com/
reported: "is not a function"
verdict:  painted 7064 changed px in 12.2s but 2 JS exception(s)
host:     HTTP 200, 190425 bytes, 0.8s, 20 <script> (11 src), 0 <img>
document: 1 stylesheets, 11 script src, 9 inline script, 0 img, 0 preload, 0 font -> 13 mandatory subresources
pixels:   changed 7064 (blank control ink 4256), ink 6065, colours 539, rich-tile proxy 9, bbox [148, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/anthropic.png

### apple -- ERRORS
url:      https://www.apple.com/
reported: 0 images; TypeError split of undefined
verdict:  painted 616492 changed px in 21.2s but 2 JS exception(s)
host:     HTTP 200, 254322 bytes, 1.2s, 20 <script> (15 src), 97 <img>
document: 9 stylesheets, 15 script src, 1 inline script, 41 img, 0 preload, 0 font -> 25 mandatory subresources
pixels:   changed 616492 (blank control ink 4256), ink 49020, colours 809, rich-tile proxy 9, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/apple.png
...
shot:     tests/scoreboard/collapse-recount/baidu.png
...
verdict:  painted 597724 changed px in 2.5s but 1 JS exception(s)
host:     HTTP 200, 185454 bytes, 0.4s, 22 <script> (4 src), 3 <img>, redirects: 302 -> https://cn.bing.com/
document: 1 stylesheets, 4 script src, 9 inline script, 1 img, 2 preload, 0 font -> 6 mandatory subresources
pixels:   changed 597724 (blank control ink 4256), ink 501170, colours 491, rich-tile proxy 16, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/bing.png

### github -- ERRORS
url:      https://github.com/
reported: "很奇怪"
verdict:  painted 221312 changed px in 95.0s but 1 JS exception(s)
host:     HTTP 200, 573816 bytes, 1.3s, 15 <script> (9 src), 24 <img>
document: 18 stylesheets, 9 script src, 0 inline script, 22 img, 77 preload, 1 font -> 28 mandatory subresources
pixels:   changed 221312 (blank control ink 4256), ink 83024, colours 2022, rich-tile proxy 25, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/github.png

### google-search -- ERRORS
url:      https://www.google.com/search?q=python
reported: "只要搜索入一个 Paton" -- the homepage renders; this is the path the owner actually uses
verdict:  painted 17432 changed px in 2.5s but 1 JS exception(s)
host:     HTTP 200, 91637 bytes, 1.4s, 5 <script> (0 src), 0 <img>
document: 0 stylesheets, 0 script src, 5 inline script, 0 img, 0 preload, 0 font -> 1 mandatory subresources
pixels:   changed 17432 (blank control ink 4256), ink 11998, colours 646, rich-tile proxy 20, bbox [152, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/google-search.png

### jd -- ERRORS
url:      https://www.jd.com/
reported: jQuery is not defined
verdict:  painted 8672 changed px in 7.9s but 7 JS exception(s) -- and the document asked for 18 subresources (3 stylesheets, 14 script srcs) against 17 requests issued, short by 1
host:     HTTP 200, 190472 bytes, 0.1s, 35 <script> (14 src), 12 <img>
...
pixels:   changed 8672 (blank control ink 4256), ink 4256, colours 410, rich-tile proxy 9, bbox [140, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/jd.png
...
verdict:  painted 12288 changed px in 35.7s but 1 JS exception(s)
...
pixels:   changed 12288 (blank control ink 4256), ink 9303, colours 684, rich-tile proxy 18, bbox [152, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/kimi.png

### openai -- ERRORS
url:      https://openai.com/
reported: an icon and nothing else
verdict:  painted 25904 changed px in 2.5s but 1 JS exception(s)
host:     HTTP 403, 0 bytes, 0.3s, 0 <script> (0 src), 0 <img>
pixels:   changed 25904 (blank control ink 4256), ink 5094, colours 675, rich-tile proxy 11, bbox [152, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/openai.png

### python -- ERRORS
url:      https://www.python.org/
reported: (new 2026-08-28: user reports it does not open)
verdict:  painted 612836 changed px in 6.1s but 1 JS exception(s) -- and the document asked for 15 subresources (4 stylesheets, 10 script srcs) against 14 requests issued, short by 1
host:     HTTP 200, 52537 bytes, 1.1s, 13 <script> (10 src), 1 <img>
...
shot:     tests/scoreboard/collapse-recount/python.png

### qwen -- ERRORS
url:      https://chat.qwen.ai/
reported: hangs
verdict:  painted 614968 changed px in 60.5s but 2 JS exception(s)
...
pixels:   changed 614968 (blank control ink 4256), ink 510839, colours 596, rich-tile proxy 9, bbox [140, 12, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/qwen.png

### stripe -- ERRORS
url:      https://stripe.com/
reported: 73 scripts, extremely slow
verdict:  painted 21956 changed px in 26.1s but 1 JS exception(s)
host:     HTTP 200, 653733 bytes, 2.0s, 77 <script> (74 src), 35 <img>
document: 5 stylesheets, 73 script src, 0 inline script, 35 img, 13 preload, 2 font -> 79 mandatory subresources
pixels:   changed 21956 (blank control ink 4256), ink 12988, colours 693, rich-tile proxy 9, bbox [152, 16, 1264, 764]
...
shot:     tests/scoreboard/collapse-recount/stripe.png

### bilibili -- PAINTED
url:      https://www.bilibili.com/
reported: TypeError split of undefined
verdict:  painted 224164 changed px in 23.0s, no JS exceptions, no subresource gap
host:     HTTP 200, 116652 bytes, 0.3s, 21 <script> (8 src), 13 <img>
document: 1 stylesheets, 6 script src, 12 inline script, 12 img, 1 preload, 0 font -> 8 mandatory subresources
pixels:   changed 224164 (blank control ink 4256), ink 164550, colours 17287, rich-tile proxy 785, bbox [140, 12, 1264, 764]
network:  22 requests, 9 connections dialled, 13 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/bilibili.png
...
host:     HTTP 200, 98223 bytes, 0.4s, 20 <script> (6 src), 3 <img>, redirects: 302 -> https://cn.bing.com/search?q=python
document: 91 stylesheets, 6 script src, 14 inline script, 1 img, 4 preload, 0 font -> 98 mandatory subresources
pixels:   changed 13032 (blank control ink 4256), ink 4776, colours 491, rich-tile proxy 10, bbox [140, 12, 1264, 764]
network:  99 requests, 5 connections dialled, 95 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/bing-search.png

### control-example -- PAINTED
url:      http://example.com/
reported: CONTROL: the simplest page on the web, no JS, no CSS worth the name
verdict:  painted 8772 changed px in 1.3s, no JS exceptions, no subresource gap
...
pixels:   changed 8772 (blank control ink 4256), ink 9184, colours 545, rich-tile proxy 9, bbox [140, 16, 1260, 764]
network:  1 requests, 1 connections dialled, 0 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/control-example.png

### control-wikipedia -- PAINTED
url:      https://en.wikipedia.org/wiki/Operating_system
reported: CONTROL: known to render since M13
verdict:  painted 82556 changed px in 15.8s, no JS exceptions, no subresource gap
host:     HTTP 200, 676091 bytes, 0.9s, 5 <script> (1 src), 26 <img>
...
non-executable <script> blocks skipped: 1
shot:     tests/scoreboard/collapse-recount/control-wikipedia.png

### deepseek -- PAINTED
url:      https://www.deepseek.com/
reported: blank; needs Worker
verdict:  painted 615860 changed px in 4.3s, no JS exceptions, no subresource gap
...
pixels:   changed 615860 (blank control ink 4256), ink 18178, colours 1331, rich-tile proxy 39, bbox [140, 12, 1264, 768]
network:  22 requests, 2 connections dialled, 20 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/deepseek.png

### google -- PAINTED
url:      https://www.google.com/
reported: "验证都无法加载出来" -- the bot check appears and its challenge will not render
verdict:  painted 17716 changed px in 3.1s, no JS exceptions, no subresource gap
host:     HTTP 200, 86859 bytes, 0.6s, 10 <script> (0 src), 1 <img>
document: 1 stylesheets, 0 script src, 10 inline script, 1 img, 0 preload, 0 font -> 2 mandatory subresources
pixels:   changed 17716 (blank control ink 4256), ink 5607, colours 735, rich-tile proxy 10, bbox [140, 16, 1260, 764]
network:  4 requests, 2 connections dialled, 2 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/google.png

### qq -- PAINTED
url:      https://www.qq.com/
reported: Uncaught (in promise) undefined
verdict:  painted 243864 changed px in 16.4s, no JS exceptions, no subresource gap
host:     HTTP 200, 126947 bytes, 0.2s, 13 <script> (7 src), 17 <img>
document: 1 stylesheets, 6 script src, 6 inline script, 16 img, 0 preload, 0 font -> 8 mandatory subresources
pixels:   changed 243864 (blank control ink 4256), ink 148384, colours 1049, rich-tile proxy 45, bbox [140, 12, 1264, 764]
network:  16 requests, 7 connections dialled, 9 reused, 0 modules (0 failed)
shot:     tests/scoreboard/collapse-recount/qq.png
