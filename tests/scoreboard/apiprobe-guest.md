# Site scoreboard apiprobe-guest

commit 9ba575e93, ISO build-apis/logit.iso (sha256:82ec5e3a8dc5be9e), 1 sites (+0 controls), 1 run(s) each, 44 s wall
...
|--------------------|------------|--------|-------|----------|-----|------------|-------------|----------|
| apiprobe           | PAINTED    |    0.7 |     1 |        - |   0 |      22000 |      13/185 | unreachable |
...
verdict:  painted 22000 changed px in 0.7s, no JS exceptions, no subresource gap
host:     UNREACHABLE (RemoteDisconnected: Remote end closed connection without response)
pixels:   changed 22000 (blank control ink 4256), ink 21244, colours 605, rich-tile proxy 11, bbox [152, 16, 1264, 764]
network:  1 requests, 1 connections dialled, 0 reused, 0 modules (0 failed)
shot:     tests/scoreboard/apiprobe-guest/apiprobe.png
