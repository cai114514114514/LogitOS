...
# (c/kernel/exec/fd/file.c). "The largest file that can be opened" was therefore
...
OBJ="$D/file_slurp.o"
eval "$(printf '%s' "$CC_LINE" | sed -e "s#-o build/c/kernel/exec/fd/file.o#-DFILE_SLURP -o $OBJ#")"
