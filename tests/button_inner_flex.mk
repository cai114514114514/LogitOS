...
$(BUTTON_INNER_DIR)/test: $(BUTTON_INNER_DEPS)
	...
	$(CC) -O2 -w $(BTEST_INC) $(CSS_INC) -Ic/kernel/mm -o $@ $(sort $(BUTTON_INNER_SRC) $(HTML_PARSER_SRC)) $(BUILD)/libcss_host.a $(RUST_LIB_HOST) -lm
$(BUTTON_INNER_DIR)/legacy: $(BUTTON_INNER_DEPS)
	@mkdir -p $(BUTTON_INNER_DIR)
	$(CC) -O2 -w -DLAYOUT_BUTTON_INNER_FLEX_LEGACY $(BTEST_INC) $(CSS_INC) -Ic/kernel/mm -o $@ $(sort $(BUTTON_INNER_SRC) $(HTML_PARSER_SRC)) $(BUILD)/libcss_host.a $(RUST_LIB_HOST) -lm
