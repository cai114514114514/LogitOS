...
static void wm_render_locked(void)
{
     ...
     * no source on this side: render_region() is void here and
     * win_open_scale() moved into win_draw_rect(). Carrying the line anyway
     * would have left a variable that is provably always 0 under a comment
