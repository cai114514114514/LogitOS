 ...
 *
 * c/kernel/mm/virt/fault.c's fault_frame() asks the allocator for a frame, forces a
 * reclaim pass when that fails, and then returns 0. A 0 there means the fault
 * declines, and c/kernel/cpu/irq/interrupts.c terminates the faulting process.
 *
