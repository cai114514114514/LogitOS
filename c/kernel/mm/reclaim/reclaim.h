 ...
 *   - a file read through an fd lands in a kmalloc buffer (c/kernel/exec/fd/file.c
 ...
 *
 * TIER 1 GAINED A SECOND PRODUCER: THE PAGE CACHE (c/kernel/mm/cache/pcache.h). A
