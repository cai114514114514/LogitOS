 ...
 * weight:
 *
 * 1. IT WOULD BE A SECOND LOADER. c/kernel/exec/load/elf.c is now a real ELF64
 ...
 * c/kernel/mm/cache/pcache.h handle from pcache_file_open(), or -1 for "no identity"
 ...
 * Kept at its v1 signature: c/kernel/gui/wm.c and c/kernel/exec/load/exec.c call it
