...
#include "kernel/sync/wait.h"   /* M27: a pipe waits, it does not poll */
 ...
 * c/kernel/exec/fd/kpoll.h, written for whoever picks it up. */
 ...
 * explicitly interrupt-safe (c/kernel/sync/wait.h rule 3) and the registry is
 * static.
 *
