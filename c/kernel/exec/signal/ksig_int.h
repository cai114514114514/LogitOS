...
/* Private to the two ksignal TUs. c/kernel/exec/signal/ksignal.c owns the table and
 * the bookkeeping; c/kernel/exec/signal/ksigframe.c owns the frame that is pushed onto
