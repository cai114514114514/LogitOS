 ...
 *   - c/kernel/exec/load/elf.h already carries the ELF64 structures, so the header
...
/* Regions recorded in the LOGIT note. c/kernel/mm/virt/vma.h's VMA_MAXAREA is 32,
...
/* ------------------------------------------------------------- THE KERNEL */
/* Called from the ring-3 fault path in c/kernel/cpu/irq/interrupts.c, in the
