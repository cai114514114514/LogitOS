 ...
 * c/kernel/cpu/irq/interrupts.c, and it is the tail of EVERY kernel entry: syscall
...
/* The console byte source. c/kernel/exec/fd/file.c's tty_read calls this instead
