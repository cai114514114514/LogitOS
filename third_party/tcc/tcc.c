...
static const char version[] =
    "tcc version "TCC_VERSION" ("
        ...
        " FreeBSD"
#elif defined TCC_LOGIT
        /* The OS the OUTPUT runs on, which is what every other arm of this
         * string reports; "Linux" here would describe neither the host that
         * built this binary nor the machine it targets. */
        " LogitOS"
#else
        " Linux"
#endif
